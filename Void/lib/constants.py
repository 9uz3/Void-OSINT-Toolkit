"""Void OSINT Toolkit — constants, paths, theme palette."""
import colorsys
import os
...
VERSION = "1.1.0"
GITHUB = "https://github.com/9uz3"
TELEGRAM = "https://discord.gg/esXFX6gkq"
TELEGRAM_TAG = "discord.gg/esXFX6gkq"
DISCORD = "https://discord.gg/esXFX6gkq"
DISCORD_TAG = "discord.gg/esXFX6gkq"
SHOP = ""
AUTHOR = "9uz3"
...
CHANGELOG = """VOID OSINT TOOLKIT v1.1.0
- OSINT-focused modular toolkit
- 12 categories: Email, Phone, IP, Username, Domain, Social, Breach, Web, Dork, Image, About
- Rich terminal dashboard with themes
...
THEME_LABELS = {
    "red": ("Rouge", "Red"), "green": ("Vert", "Green"),
    "blue": ("Bleu", "Blue"), "yellow": ("Jaune", "Yellow"),
    "purple": ("Violet", "Purple"), "cyan": ("Cyan", "Cyan"),
    "orange": ("Orange", "Orange"), "pink": ("Rose", "Pink"),
    "lime": ("Lime", "Lime"), "white": ("Blanc", "White"),
    "rose": ("Rose vif", "Rose"), "gold": ("Or", "Gold"),
    "rainbow": ("Arc-en-ciel", "Rainbow"),
}

THEME_ORDER = list(THEMES.keys()) + ["rainbow"]
_THEME_ALIASES = {"crimson": "red", "midnight": "purple", "white": "white"}
_ACTIVE_THEME = "white"
...
C_BLOOD = THEMES["white"]["blood"]
C_DARK = THEMES["white"]["dark"]
C_MID = THEMES["white"]["mid"]
C_RED = THEMES["white"]["red"]
C_NEON = THEMES["white"]["neon"]
C_BRIGHT = THEMES["white"]["bright"]
